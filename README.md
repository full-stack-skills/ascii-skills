...
[![GitHub](https://img.shields.io/badge/github-full--stack--skills%2Fascii-skills-green.svg)](https://github.com/full-stack-skills/ascii-skills)
...
```bash
npx skills add full-stack-skills/ascii-skills --skill <skill-name>
```
...
```bash
git clone https://github.com/full-stack-skills/ascii-skills.git
